...
/// tests : 1319779
/// testsPerOneMillion : 32384
/// population : 40754388
/// continent : "Asia"
/// oneCasePerPeople : 179
/// oneDeathPerPeople : 5125
/// oneTestPerPeople : 31
/// activePerOneMillion : 295.31
/// recoveredPerOneMillion : 5086.77
...
class CoutriesModel {
  ...
  CoutriesModel.fromJson(dynamic json) {
...
CoutriesModel copyWith({  num? updated,
  String? country,
  CountryInfo? countryInfo,
  num? cases,
  num? todayCases,
  ...
  num? recoveredPerOneMillion,
  num? criticalPerOneMillion,
}) => CoutriesModel(  updated: updated ?? _updated,
