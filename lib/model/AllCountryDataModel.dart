...
/// active : 21221285
/// critical : 38049
/// casesPerOneMillion : 89415
/// deathsPerOneMillion : 889.3
/// tests : 7008151946
/// testsPerOneMillion : 882090.52
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2671.05
/// recoveredPerOneMillion : 84182.13
...
class AllCountryDataModel {
  ...
  AllCountryDataModel.fromJson(dynamic json) {
...
AllCountryDataModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => AllCountryDataModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
